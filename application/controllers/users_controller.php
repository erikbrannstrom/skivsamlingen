...
class Users_Controller extends MY_Controller {
    ...
    function profile($username = NULL) {
        ...
        $num = ($this->data['num_records'] >= 25) ? 10 : 5;
        $this->data['top_artists'] = $this->User->getTopArtists($num, $user->id);
        $this->data['latest_records'] = $this->User->getLatestRecords($user->id, $num);
    }
